...
#define AI_AXISRAM3_4_5_6   _Pragma("location=\"AI_AXISRAM3_4_5_6\"")
#define AI_XSPI1   _Pragma("location=\"AI_XSPI1\"")
#elif defined ( __CC_ARM ) || ( __GNUC__ )
#define AI_RAM   __attribute__((section(".AI_RAM")))
#define AI_AXISRAM3_4_5_6   __attribute__((section(".AI_AXISRAM3_4_5_6")))
#define AI_XSPI1   __attribute__((section(".AI_XSPI1")))
#endif
