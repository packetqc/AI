...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "model_npu_qdq"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x15d7930dc226850d64430195fc002a21"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0xf867dae61a137e3f)
...
#define STAI_NETWORK_NODES_NUM           (179)

/*  Macro to declare number macc for generated network model  */
#define STAI_NETWORK_MACC_NUM            (241438339)
...
#define STAI_NETWORK_IN_FORMATS \
  { STAI_FORMAT_S32, STAI_FORMAT_S32}
...
#define STAI_NETWORK_IN_1_FORMAT      (STAI_FORMAT_S32)
#define STAI_NETWORK_IN_1_SHAPE       {1,32}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (32)
#define STAI_NETWORK_IN_1_RANK        (1)
#define STAI_NETWORK_IN_1_SIZE        (32)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (128)

#define STAI_NETWORK_IN_2_ALIGNMENT   4
#define STAI_NETWORK_IN_2_NAME        (NULL)
#define STAI_NETWORK_IN_2_FLAGS       (STAI_FLAG_INPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_LAST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_IN_2_FORMAT      (STAI_FORMAT_S32)
#define STAI_NETWORK_IN_2_SHAPE       {1,32}
#define STAI_NETWORK_IN_2_BATCH       (1)
#define STAI_NETWORK_IN_2_CHANNEL     (32)
#define STAI_NETWORK_IN_2_RANK        (1)
#define STAI_NETWORK_IN_2_SIZE        (32)
#define STAI_NETWORK_IN_2_SIZE_BYTES  (128)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (11972)
...
#define STAI_NETWORK_OUT_1_SHAPE       {1,32,1,374}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_HEIGHT      (32)
#define STAI_NETWORK_OUT_1_WIDTH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (374)
#define STAI_NETWORK_OUT_1_RANK        (3)
#define STAI_NETWORK_OUT_1_SIZE        ((32 * 1 * 374))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (11968)
#define STAI_NETWORK_OUT_1_SCALE       (0.06943628191947937f)
#define STAI_NETWORK_OUT_1_ZERO_POINT  (-52)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (331032)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (331032)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (331032)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (331032)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (1383956)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (1383956)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (1383956)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (1383956)
