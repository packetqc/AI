...
#define STAI_MNETWORK_IN_NUM 2
#define STAI_MNETWORK_IN_1_SIZE_BYTES 4
#define STAI_MNETWORK_IN_1_SIZE 1
#define STAI_MNETWORK_IN_2_SIZE_BYTES 4
#define STAI_MNETWORK_IN_2_SIZE 1

#define DEF_DATA_IN \
STAI_ALIGNED(32) static uint8_t data_in_1[STAI_MNETWORK_IN_1_SIZE_BYTES]; \
STAI_ALIGNED(32) static uint8_t data_in_2[STAI_MNETWORK_IN_2_SIZE_BYTES]; \
stai_ptr data_ins[] = { \
  data_in_1, \
  data_in_2 \
}; 
