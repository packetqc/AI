...
*/
/* HAL_CACHEAXI_MspInit/MspDeInit are provided by the CubeMX-generated
 * stm32n6xx_hal_msp.c (CACHEAXI is enabled in the .ioc), so they are disabled
 * here to avoid a multiple-definition link error — MX owns the CACHEAXI MSP.
 * The npu_cache_* maintenance functions above are kept (Neural-ART runtime). */
#if 0
