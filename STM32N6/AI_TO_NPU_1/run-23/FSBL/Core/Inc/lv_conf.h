...
/* N6_EDGEAI_1: L0 is RGB565 (display.c switches MX's default RGB888→RGB565
 * via HAL_LTDC_SetPixelFormat). LVGL matches — halves draw buffer and
 * framebuffer bandwidth vs RGB888. */
